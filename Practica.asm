...
.text
	main:
		...
		add $s6, $s0, $0			# Dejo $s6 en la direccón de $s0 para recorrerlo del derecho
		...
		add $s3, $0, $0 			# Deja el registro $s3 a 0 (media aritmética)
...
# realiza? 
# Cuando se observa la consola (en la parte inferior, pestaña Run I/O) ¿Por qué el programa no
